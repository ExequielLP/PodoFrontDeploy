...
export const Metrics = () => {
  return (
    <div className="metrics-container">
      <h2 className="metrics-title">¿Por qué elegirnos?</h2>
      <div className="metrics-grid">
        <div className="metrics-feature">
          <AwardIcon className="metrics-icon" color="#ed64a6" size={48} />
          <h3 className="metrics-feature-title">Experiencia Comprobada</h3>
        ...
        <div className="metrics-feature">
          ...
          <h3 className="metrics-feature-title">Soporte 24/7</h3>
          <p className="metrics-feature-description">
        ...
        <div className="metrics-feature">
          ...
          <h3 className="metrics-feature-title">Satisfacción Garantizada</h3>
